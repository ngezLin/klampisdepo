...
* Refer to [backend.md](file:///C:/Projects/klampisdepo/llm-context/skills/backend.md) for Go + Gin + GORM backend code standards, guard clauses, SQLi prevention, pagination, and rate limiting.
* Refer to [deploy_skills.md](file:///C:/Projects/klampisdepo/llm-context/skills/deploy_skills.md) for cross-compiling, SCP, and VPS systemd service deployment runbooks.
* Refer to [SKILLS.md](file:///C:/Projects/klampisdepo/llm-context/SKILLS.md) for mobile (Flutter/Riverpod) and frontend (React/Tailwind) skills.
* Refer to [LESSONS.md](file:///C:/Projects/klampisdepo/llm-context/LESSONS.md) to review past pitfalls and avoid repeating errors.
* Refer to [GUIDELINES.md](file:///C:/Projects/klampisdepo/llm-context/GUIDELINES.md) for code styling and patterns.
